...
function Features({ errors, formData, setFormData, img }) {
  const featuresChange = (event) => {
    setFormData({
      ...formData,
      featuresContrast: event.target.value,
    });
  };
  return (
    <form className="question">
      ...
      <RadioGroup
        ...
        defaultValue={formData.featuresContrast}
        value={formData.featuresContrast}
